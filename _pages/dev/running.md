...
# What to do next?
Now that you're done with the set up, you can get to do some real coding. Take a look at [these tutorials](/dev/#first-game) for some pointers on where to start.
