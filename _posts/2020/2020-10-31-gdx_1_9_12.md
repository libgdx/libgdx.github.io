...
- There is now also the possibility to lazy load assets via AssetManager instead of preloading them before game start. See [here](https://github.com/libgdx/libgdx/wiki/HTML5-Backend-and-GWT-Specifics#speeding-up-preload-process) for more information. 
