...
**Known issues:** At the moment, Box2D collision filtering is working unreliably with libGDX 1.9.12. We're working on [a fix](https://github.com/libgdx/libgdx/pull/6262), but for the time being you are advised to stay on 1.9.11 if you are relying on filtering.
{: .notice--warning}
